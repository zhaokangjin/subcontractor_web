...
@NgModule( {
imports:[
    CommonModule, UserRouter
  ], 
declarations:[UserDetailComponent, 
IndexComponent, UserDetailComponent, UserEducationComponent, UserInfoComponent, UserLoginComponent, UserPasswordComponent, 
UserProjectComponent, UserRegisterComponent, UserSkillComponent, UserWorkexperienceComponent]
})
